...
const allSettingsNavigation: SettingsNavItem[] = [
  ...
  { name: "PX Settings", href: "/settings/hr-settings", icon: UserCheck, permission: "settings.hr.view" },
  ...
  { name: "Roles & Permissions", href: "/settings/roles-permissions", icon: Shield, permission: "settings.roles.view" },
  { name: "Permission Audit", href: "/settings/permission-audit", icon: ShieldCheck, permission: "settings.roles.view" },

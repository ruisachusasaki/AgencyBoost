...
- **HR Features**: Time off requests, job application form configuration, job application watchers, expense reports, and a 1-on-1 meeting tracker.
  ...
  - **1-on-1 Meetings**: Meeting recording link field for storing Fathom/Google Meet URLs. Position-specific KPIs automatically displayed based on staff member's role with status tracking (On-Track, Off-Track, Complete) per meeting using dropdown selectors.

...
- Responsive tab navigation with intelligent overflow menus: HR section tabs automatically adapt to screen size, showing visible tabs inline and placing overflow tabs in a "..." dropdown menu. Breakpoints: XL (≥1400px) shows all tabs, Large (≥1200px) shows 6, Medium (≥900px) shows 4, Small (≥600px) shows 3, and Extra Small (<600px) shows 2 tabs.

...
- **HR Features**: Time off requests, job application forms, expense reports, 1-on-1 meeting tracker, performance reports, interactive organization chart, and New Hire Onboarding Checklists (template builder with drag-and-drop day/item management, KB article and training course linking, spawn service for auto-creating checklists on staff creation, new hire view under HR > Onboarding Checklist tab with day-by-day checklist, progress tracking, circular checkboxes, day unlock logic for calendar/completion modes, and optimistic UI updates). Includes PX Meetings for collaborative team meetings.
